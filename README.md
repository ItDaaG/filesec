...
fileSec is a personal file storage platform where a multi-agent AI system **Cipher** handles file management, organisation, and semantic search through plain natural language, backed by an authoritative backend state that keeps the AI honest about what actually exists.
